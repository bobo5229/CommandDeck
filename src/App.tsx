  ...
  return (
    <div className="deck-app-container">
      ...
      <main className="deck-scroll-area">
        ...
        <NowSection tasks={state.now} onEdit={(task) => { setEditing(task); setEditorOpen(true); }} onStatus={status} onProgressCreate={progressCreate} onProgressUpdate={progressUpdate} onProgressDelete={progressDelete} />
      ...
      <NewTaskButton onClick={() => { setEditing(undefined); setEditorOpen(true); }} />
